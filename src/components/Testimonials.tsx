      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          ...
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            Our business model is designed to give your family valuable time
            back. People love us because we make sure your menial tasks are
            taken cared of. Done well and with your satisfaction top of mind.
          </p>
        </div>
        <ul
          role="list"
