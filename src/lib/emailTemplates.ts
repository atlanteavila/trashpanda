  ...
  <html lang="en">
    ...
    <body style="margin:0; padding:0; background:${brandColors.light}; font-family: 'Inter', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; color:${brandColors.slate};">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${brandColors.light}; padding: 24px 0;">
        <tr>
          <td align="center">
            <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius: 16px; box-shadow: 0 18px 40px rgba(15, 23, 42, 0.12); overflow: hidden; border: 1px solid #e2e8f0;">
              <tr>
            ...
            <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="margin-top: 12px; color:#64748b; font-size: 12px;">
              <tr>
